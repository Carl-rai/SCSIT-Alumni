...
export default function ViewJobAdminPage() {
    ...
    <div className="flex min-h-screen bg-[#020d1f] text-gray-100">
      ...
      <main className="lg:ml-64 flex-1 p-4 lg:p-8 pt-20 lg:pt-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          <button
            onClick={() => router.push("/admin-dashboard/add-jobadmin")}
              ...
              <div key={job.id} className="bg-white/3 border border-white/8 rounded-2xl overflow-hidden hover:border-yellow-500/30 transition-all group">
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start mb-3">
                    <h2 className="text-lg font-bold text-yellow-400 leading-tight">{job.job_title}</h2>
                    {!job.image && (
                  ...
                  <div className="text-xs text-gray-500 space-y-0.5 mb-4">
                    ...
                    <p>Experience: <span className="text-gray-400">{EXP[job.experience_level] || job.experience_level}</span></p>
                    {job.salary_range && <p>Salary: <span className="text-gray-400">{job.salary_range}</span></p>}
                  </div>

                  <div className="flex gap-2 pt-3 border-t border-white/8">
                    <Link href={`/admin-dashboard/edit-jobadmin/${job.id}`}
