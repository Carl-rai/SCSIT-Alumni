...
export default function AddJobStaffPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) { alert("Job posted!"); router.push("/staff-dashboard/view-jobstaff"); }
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white/3 border border-white/8 rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <input name="industry" placeholder="Industry / Field" value={form.industry} onChange={handleChange} className={inputCls} required />
              ...
              <input name="location" placeholder="Location" value={form.location} onChange={handleChange} className={inputCls} required />
