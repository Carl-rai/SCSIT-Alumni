...
import { ArrowLeft, GraduationCap, Hash, Calendar, BookOpen, Users, Sparkles, Save, Loader, User } from "lucide-react";
import { apiUrl } from "@/lib/api";

export default function StaffEditAlumniPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push("/staff-dashboard/alumni-records");
      } else {
        const data = await res.json();
      ...
      <div className="flex-1 lg:ml-64 relative z-10">
        ...
        <header className="sticky top-14 lg:top-0 z-30 bg-[#020d1f]/90 backdrop-blur-md border-b border-blue-800/40 px-4 lg:px-8 py-4 mt-14 lg:mt-0">
          <div>
            ...
            <p className="text-blue-400 text-sm">Staff Dashboard <span className="text-blue-600">/ Alumni Records / Edit</span></p>
          </div>
        </header>
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
          ...
          {/* Back */}
          <button
            onClick={() => router.replace("/staff-dashboard/alumni-records")}
            ...
            <div className="relative px-6 sm:px-8 py-8">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Edit Alumni Record</h1>
                  {fullName && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={saving}
                  ...
                  {saving ? <><Loader size={16} className="animate-spin" /> Saving Changesâ€¦</> : <><Save size={16} /> Save Changes</>}
                </button>
              </form>
            </div>
          </div>
